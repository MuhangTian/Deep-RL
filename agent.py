...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", default="valid", choices=["train", "valid",], 
    ...
    parser.add_argument("--render", action="store_true", default=True, help="render game-play at validation time")
