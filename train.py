...
from model import PolicyNetwork, ActorNetworkCNN, ActorNetworkLSTM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="an_lstm", help="model to use")
    ...
    parser.add_argument("--save_path", type=str, default='trained/a2c_lstm.pt', help="save model here")
    parser.add_argument("--load_path", type=str, default='trained/a2c_cnn.pt', help="load model from here")
