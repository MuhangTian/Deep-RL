...
from model import PolicyNetwork, ActorNetworkSimple, ActorNetworkCNN
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="an", help="model to use")
